...
export const reset_password = (email) => async dispatch => {
    ...
    try {
        await axios.post(`https://zingmp3server.vercel.app/api/v4/reset/password/`, body, config);
...
export const reset_password_confirm = (uidb64, token, password) => async dispatch => {
    ...
    try {
        const res =await axios.post(`https://zingmp3server.vercel.app/api/v4/password-reset/${uidb64}/${token}/`, body, config);
