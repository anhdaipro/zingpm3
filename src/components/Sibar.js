...
const Sibar=()=>{
    ...
    return(
        <div className="sideNav tablet">
            <div className="sibar-content">
            <button className="" to="/"><div className="logo"></div></button>
            <div className="navigation">
                <NavLink onClick={e=>checkuser(e)} title="Cá nhân"  to="/mymusic">
                {({ isActive }) => (
                ...
                <NavLink title="#zing chart"  to="/zingchart">
                {({ isActive }) => (
                    <div className={`navigation-item ${isActive?'active':''}`}>
                    <div className="navigation-item-icon">
                ...
                {({ isActive }) => (
                    ...
                    <div className="navigation-item-title">Radio
                    <span className="">Live</span>
                    </div>
                    </div>
                )}
                </NavLink>
                <NavLink title="Theo dõi"  to="/the-loai-nghe-si/Viet-Nam">
                {({ isActive }) => (
                    <div className={`navigation-item ${isActive?'active':''}`}>
                    <div className="navigation-item-icon">
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M19.875 3H4.125C2.953 3 2 3.897 2 5v14c0 1.103.953 2 2.125 2h15.75C21.047 21 22 20.103 22 19V5c0-1.103-.953-2-2.125-2zm0 16H4.125c-.057 0-.096-.016-.113-.016-.007 0-.011.002-.012.008L3.988 5.046c.007-.01.052-.046.137-.046h15.75c.079.001.122.028.125.008l.012 13.946c-.007.01-.052.046-.137.046z"></path><path d="M6 7h6v6H6zm7 8H6v2h12v-2h-4zm1-4h4v2h-4zm0-4h4v2h-4z"></path></svg>
                    </div>
            ...
            <div className="sidebar__library">
                <div className="sidebar__library-top">
                    ...
                    <NavLink title="Nhạc mới" to="/moi-phat-hanh" aria-current="page">
                    {({ isActive }) => (
                        <div className={`navigation-item ${isActive?'active':''}`}>
                        <div className="navigation-item-icon">
                                <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
                        </div>
                        <div className="navigation-item-title">Nhạc mới</div>
                        </div>
                    )}
                    </NavLink>
                    <NavLink title="Thể loại"  to="/hub">
                    {({ isActive }) => (
                        <div className={`navigation-item ${isActive?'active':''}`}>
                        <div className="navigation-item-icon">
                    ...
                    <NavLink title="Top 100"  to="/top100">
                    {({ isActive }) => (
                        <div className={`navigation-item ${isActive?'active':''}`}>
                            <div className="navigation-item-icon">
                    ...
                    {({ isActive }) => (
                        <div className={`navigation-item ${isActive?'active':''}`}>
                            <div className="navigation-item-icon">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M21 3H3c-1.11 0-2 .89-2 2v12a2 2 0 002 2h5v2h8v-2h5c1.1 0 1.99-.9 1.99-2L23 5a2 2 0 00-2-2zm0 14H3V5h18v12zm-5-6l-7 4V7z"></path></svg>
                            </div>
