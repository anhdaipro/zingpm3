...
import { artistInfohURL,genresURL } from "../../urls"
    ...
    useEffect(() => {
        ( async ()=>{
            const res = await axios.get(`${genresURL}`,headers())
                ...
                return({...item,checked:false,name:`Top 100 ${item.name} hay nhất`})
            })
            setGenres(data) 
        })()
    }, [])
            ...
            <div key={item.id} className="slider-item">
                <Link to={`/album/${item.slug}`}>
                    <div className="playlist-image-wrapper">
                        <div className="container-discover__slider-item-img" style={{backgroundImage:`url(${item.songs[0].image_cover})`,backgroundSize:'cover',width:'100%',paddingTop:'100%'}}></div>
                        <div className="card-list-image-hover">
                            ...
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" className="card-list-icon small" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"></path></svg>
                        </div>
                    </div>
