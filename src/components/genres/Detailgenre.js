...
import {genreURL,artistInfohURL} from "../../urls"
import { actionuser, setsong, updatesongs } from "../../actions/player"
            ...
            <div className="flex">
                ...
                <div className="playlist-header mr-16">
                    <div className="playlist-image-wrapper">
                        <div className="container-discover__slider-item-img" style={{backgroundImage:`url(${songs[0].image_cover})`,backgroundSize:'cover',width:'100%',paddingTop:'100%'}}></div>
