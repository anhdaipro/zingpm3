...
import {genresURL,songURL,listsonguserURL,artistInfohURL} from "../../urls"
        ...
        <div key={item.id} className="slider-item">
            <Link to={`/album/${item.slug}`}>
                <div className="playlist-image-wrapper">
                    <div class="container-discover__slider-item-img" style={{backgroundImage:`url(${'http://localhost:8000'+item.songs[0].image_cover})`,backgroundSize:'cover',width:'100%',paddingTop:'100%'}}></div>
