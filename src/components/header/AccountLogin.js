...
const AccountLogin=()=>{
    ...
    return(
        <div ref={parentRef}  style={{position:'relative'}} aria-label="Tài khoản">
            <div onClick={(e)=>setshowlogin(e)} className="item-center">
            ...
            <div className="menu menu-settings setting-header header-dropdown">
                <ul className="menu-list">
                    ...
                    {user.singer&&(<li className="header-player-setting">
                        <a>
                            <button onClick={()=>{
                                setShow(false)
                                dispatch(showmodal(true))
                                dispatch(actionuser({data:{title:'Add feed'},action:'addfeed'}))
                                }} className="zm-btn button" tabIndex="0">
                                <span>Add feed</span>
                            </button>
                        </a>
