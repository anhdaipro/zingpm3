...
import {showmodal,showaction,actionuser,updatesongs} from "../../actions/player"
...
const Actionsong=(props)=>{
    ...
    return(
        <div ref={dotref} onClick={()=>{
            ...
            {show && (<div ref={dropref} className="detail-song" style={{position:'absolute',left:`${left}px`,top:`${top}px`,right:`${right}px`,width:'280px',transform:`translateY(-${transformY}%)`}}>
                <div style={{position:'relative'}}>
                    <div>
                            ...
                            <div className="flex-col flex-1" style={{width:0}}>
                                ...
                                <div className="flex-center">
                                    ...
                                    <div className="flex-center more-song-info">
                                        ...
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 3a9 9 0 00-9 9v7c0 1.1.9 2 2 2h4v-8H5v-1c0-3.87 3.13-7 7-7s7 3.13 7 7v1h-4v8h4c1.1 0 2-.9 2-2v-7a9 9 0 00-9-9zM7 15v4H5v-4h2zm12 4h-2v-4h2v4z"></path></svg>
                                        </span>
                        ...
                        <div class="actions">
                            <div onClick={(e)=>download(e)} class="action-item">
                                <div class="icon">
                            ...
                            <div  onClick={()=>{
                                ...
                                }} class={`action-item ${song.hasLyric?'':'disabled'}`}>
                                <div class="icon">
                            ...
                            <div class="action-item">
                                <div class="icon">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M13.477 14.89A6 6 0 015.11 6.524l8.367 8.368zm1.414-1.414L6.524 5.11a6 6 0 018.367 8.367zM18 10a8 8 0 11-16 0 8 8 0 0116 0z" clip-rule="evenodd"></path></svg>
                                </div>
                        ...
                        <div class="menus">
                            <div class="menu-item">
                                ...
                                <div class="menu-name">Set ringtone</div>
                                </div>
                            </div>
                            <div onMouseLeave={()=>setShowplaylist(false)} onMouseEnter={()=>setShowplaylist(true)} class="menu-item">
                                <div className='item-center'>
                                    <div class="menu-icon">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M13 7h-2v4H7v2h4v4h2v-4h4v-2h-4V7zm-1-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>
                                    </div>
                                    <div class="menu-name">Add to playlist</div>
                                </div>
                            ...
                            <div className='item-center'>
                                ...
                                <div class="menu-name">Play Radio Songs</div>
                                </div>
                            </div>
                            <div class="menu-item">
                            <div className='item-center'>
                                ...
                                <div class="menu-name">Play along with the lyrics</div>
                                </div>
                            </div>
                            <div onClick={showcomment} class="menu-item">
                                <div className='item-center'>
                                    <div class="menu-icon">
                    ...
                    <div onMouseLeave={()=>setShowplaylist(false)}  onMouseEnter={()=>setShowplaylist(true)} className="right-content" style={{position:'absolute',right:'90%',top:'40px'}}>
                        <div style={{minWidth:'200px'}} class="content-input">
                            <input maxlength="30" type="text" placeholder="Nhập tên playlist" />
                        </div>
                        <div onClick={addplaylist} class="sibar-add-playlist">
                            <div class="icon-add">
