                                ...
                                <div className="columns is-multiline">     
                                    <div  className="video-play">
                                        ...
                                        onClick={()=>{
                                            ...
                                            <button class="playpause-fadeout" type="button" style={{display: `${animation?'flex':'none'}`}}>
                                                ...
                                                <ControlVideo className="control-video flex">
                                                    <div className="control-left">
                                                        <div class="song-player-control item-center">
                                                            ...
                                                            <div onClick={setrepeat} className={`shuffle mv-player-button ${repeat?'active':''}`} style={{fontSize: '24px'}}>
                                                    ...
                                                    <div className="control-right">
                                                        ...
                                                        <button class="ytp-miniplayer-button mv-player-button ytp-button"  aria-label="Miniplayer (i)">
